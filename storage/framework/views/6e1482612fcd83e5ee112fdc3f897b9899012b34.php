        ...
        <div class="row px-xl-5">
            <div class="col-lg-8">
                ...
                <div class="bg-light p-30 mb-5">
                    ...
                    <form action="<?php echo e(route('payer')); ?>" id="checkout-form" method="POST" class="billing-form">
                        <?php echo csrf_field(); ?>
                        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="border-bottom pt-3 pb-2">
                        ...
                        <div class="d-flex justify-content-between">
                            <h6 class="font-weight-medium"><?php echo e($product['product_name']); ?></h6>
                            <h6 class="font-weight-medium">$<?php echo e($product['prix']); ?></h6>
                        </div>
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\anis\Desktop\e-commerce\resources\views/client/checkout.blade.php ENDPATH**/ ?>